import type { AuthFlowId, RunId, SessionId, WorkspaceId } from "@no-pi-no-gang/contracts";
...
export const gatewayKeys = {
  ...
  sessions: {
    ...
    detail: (sessionId: SessionId) => [...gatewayKeys.sessions.all, "detail", sessionId] as const,
    transcript: (sessionId: SessionId) =>
      [...gatewayKeys.sessions.all, "transcript", sessionId] as const,
    snapshot: (sessionId: SessionId) =>
      [...gatewayKeys.sessions.all, "snapshot", sessionId] as const,
    runs: (sessionId: SessionId) => [...gatewayKeys.sessions.all, "runs", sessionId] as const,
  },
  runs: {
