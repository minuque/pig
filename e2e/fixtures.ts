...
type TestFixtures = { gateway: E2eGateway; complexGateway: E2eGateway; bodyLcpGateway: E2eGateway }
...
export const test = base.extend<TestFixtures>({
  ...
  bodyLcpGateway: [
    async ({}, use) => {
      await withGateway((sessionDir, workspaceDir) => {
        prebuildComplexSession(sessionDir, workspaceDir)
        seedShortBodySession(sessionDir, workspaceDir)
      }, use)
    },
    { scope: "test" },
  ],
