...
Which Vue-compatible Markdown, syntax-highlighting, sanitization, streaming-update, copy/accessibility, and long-transcript strategy best fits project-owned Apple-derived components without introducing React, SSR, unsafe HTML, or premature virtualization?
