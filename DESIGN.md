...
深色是同一套分面的近黑反相：对话 `#0a0a0a`、侧栏 `#050505`、输入卡 `#121212`、用户气泡 `#141414`、缝 `#2c2c2e`。次级井仍用 `#1b1b1c`。装饰用 sunset / dusk / twilight / breeze。阶段与栏目标签可用 `{typography.caption-mono}`。
...
8px 基准。侧栏内边距 12/6；列表行 28–32px；对话列与输入卡固定 748px 居中，侧栏拖拽只改变两侧留白。
...
- 浅色：侧栏软底，对话白底。
- 深色：对话 `#0a0a0a`、侧栏 `#050505`、输入卡 `#121212`、用户气泡 `#141414`、缝 `#2c2c2e`。
